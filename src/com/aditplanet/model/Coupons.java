...
public class Coupons {
	...
	public String toString(){
		...
		return "code: " + this.code + ", details: " + this.coupon_details + "valid_status:" +this.valid_status;
	}
	
	public Coupons(JSONObject coupons){
		try {
			this.code = coupons.getString("code");
			this.valid_status = (coupons.getString("valid_status").equals("1") ? true : false);
			this.valid_date = DateParser.parseDate(coupons.getString("valid_date"));
			this.merchant = coupons.getString("merchant");
			this.coupon_details = coupons.getString("coupon_details");
			this.valid_start_date = DateParser.parseDate(coupons.getString("valid_start_date"));
			this.valid_end_date = DateParser.parseDate(coupons.getString("valid_end_date"));
