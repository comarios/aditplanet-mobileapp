...
public class LazyAdapter extends BaseAdapter {
	...
	private static final String NOT_VALIDATED_YET = "0000-00-00 00:00:00";
	...
	/**
	 * List that contains map. Each map contains data for each element of the
	 * list view.
	 */
	...
	public void addToContentList(Coupons coupons) {
		...
		// p.getProfileImage(newLocationData.getProfile()));
		// map.put(LazyAdapter.KEY_SUBTITLE,
		// p.getProfileMessage(newLocationData.getProfile()));
		...
		map.put(LazyAdapter.KEY_COUPON_VALIDATION,
				coupons.getValid_dateAsString());
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView couponDetails = (TextView) vi
				.findViewById(R.id.coupon_details);
		...
		if (coupons.get(KEY_COUPON_DETAILS).equals(NOT_VALIDATED_YET)) {
			couponDetails.setText("Validated Date: Not Validated yet");
		} else {
			couponDetails.setText("Validated Date: "
					+ coupons.get(KEY_COUPON_DETAILS));
		}
